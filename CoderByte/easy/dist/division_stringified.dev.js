...
function divisionStringified(num1, num2) {
  ...
  var quotientString = Math.round(num1 / num2).toString(); // Process array from right-to-left to add commas, but more pragmatically
  // will just reverse the numbers and work left-to-right

  var reversedData = quotientString.split('').reverse();
  var formattedString = '';
